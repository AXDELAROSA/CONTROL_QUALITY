...
GO
--		 EXECUTE [dbo].[PG_LI_HOJA_EMPAQUE_COLORES] 0,139, 'DAIM05' , 'WDK' , '8' , 0, 'PL2ARLH'
--		 EXECUTE [dbo].[PG_LI_HOJA_EMPAQUE_COLORES] 0,139, 'FAUR01'	, 'FW2'	, '11',	0, 'PWSSC20'
--		 EXECUTE [dbo].[PG_LI_HOJA_EMPAQUE_COLORES] 0,139, 'FAUR01'	, 'FW2'	, '11',	0, 'PWSFCL2'
...
GO
--		 EXECUTE [dbo].[PG_LI_PROCESO_SIMBOLO] 0,139, 2
...
GO
--		 EXECUTE [dbo].[PG_LI_HOJA_EMPAQUE_CAPA] 0,139,	'FAUR01'	, 'FW2'	, '11',	'PWSSC20'
--		 EXECUTE [dbo].[PG_LI_HOJA_EMPAQUE_CAPA] 0,139,	'FAUR01'	, 'FW2'	, '11',	'PWSFCL2'
...
BEGIN TRY
	...
	-- =======================================================================================================================	
	DECLARE	@VP_RUTA_HOJA_EMPAQUE_CAPA_SERVIDOR		AS NVARCHAR(MAX)	=	'\\10.1.1.5\documents\IT\001_DEVELOPER_FILES\APQP\AV_HE\'
