...
ALTER TABLE [dbo].[HOJA_EMPAQUE_PROCESO]
	ADD		[ITEM_NO]			[VARCHAR](50)	NOT NULL DEFAULT '';	-- SE AGREGA LA COLUMNA PARA MOSTRAR LOS DATOS DEL CLIENTE YANGFENG	AX: 20220217
GO
--ALTER TABLE [dbo].[HOJA_EMPAQUE_PROCESO]
--	ADD		[K_USUARIO_ALTA]			[INT] NOT NULL,
--			[F_ALTA]					[DATETIME] NOT NULL,
...
ALTER TABLE [dbo].[HOJA_EMPAQUE_CAPA]
	ADD		[U_ITEM]			[VARCHAR](50)	NOT NULL DEFAULT '';	-- SE AGREGA LA COLUMNA PARA MOSTRAR LOS DATOS DEL CLIENTE YANGFENG	AX: 20220217
GO
-- ////////////////////////////////////////////////////////////////
...
ALTER TABLE [dbo].[HOJA_EMPAQUE]								--AX: 20220124
	ADD		[U_ITEM]			[VARCHAR](250) DEFAULT ''
GO
