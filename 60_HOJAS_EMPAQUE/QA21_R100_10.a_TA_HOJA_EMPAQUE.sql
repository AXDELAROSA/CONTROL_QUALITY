...
--ALTER TABLE [dbo].[HEADER_HOJA_EMPAQUE] ADD 
--	CONSTRAINT [FK_STATUS_HOJA_EMPAQUE_01] 
--		FOREIGN KEY ( K_STATUS_HOJA_EMPAQUE ) 
--		REFERENCES [dbo].[STATUS_HOJA_EMPAQUE] (K_STATUS_HOJA_EMPAQUE )
--GO
