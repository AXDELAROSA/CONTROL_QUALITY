...
--		 EXECUTE [dbo].[PG_LI_HOJA_EMPAQUE_COLORES_U]	0,139, 'YANG02'	, 'WL5'	, '4',	'PYFRBOLYPAWT5'	,'0' 
--		 EXECUTE [dbo].[PG_LI_HOJA_EMPAQUE_COLORES_U]	0,139, 'YANG02'	, 'WL5'	, '4',	'PYFRBOLYPATX7'	,'0' 
...
--		 EXECUTE [dbo].[PG_LI_HOJA_EMPAQUE_PROCESO_U] 0,139, 'YANG02'	, 'WL5'	, '4',	'PYFRBOLYPAWT5'	,'0'
--		 EXECUTE [dbo].[PG_LI_HOJA_EMPAQUE_PROCESO_U] 0,139, 'YANG02'	, 'WL5'	, '4',	'PYFRBOLYPATX7'	,'0'
...
AS
	...
	IF @PP_CUS_NO	IN ('YANG02')	AND @PP_MODELNO	= 'WL5'
	BEGIN
		DECLARE @VP_ITEM_P_U_KIT	AS VARCHAR(100)	= ''
	END
	ELSE
	BEGIN
		SET		@PP_ITEM_P	= LEFT(LTRIM(RTRIM(@PP_ITEM_P)),7)
	...
	BEGIN
		...
		-- =======================================================================================================================
			EXECUTE	[dbo].[PG_IN_HOJA_EMPAQUE_U]	@PP_K_SISTEMA_EXE,	@PP_K_USUARIO_ACCION,
				...
				SET @VP_MENSAJE='Función no habilitada informar a SISTEMAS. (Revisión)(N)[HE#'+CONVERT(VARCHAR(10),@PP_ITEM_P )+']'
				RAISERROR (@VP_MENSAJE, 16, 1 ) 
		END
		ELSE
		BEGIN
