...
--	[PG_LI_HOJA_EMPAQUE_COLORES]		--	FUE REEMPLAZADO POR EL QUE FUNCIONARÁ PARA LOS U NUMBERS			(VIEJO)
--	[PG_LI_HOJA_EMPAQUE_COLORES_U]		--	PARA REEMPLAZAR EL USADO ACTUALMENTE								(NUEVO)
