...
/*
 EXEC	[dbo].[PG_ENCABEZADO_LIBERAR_ORDEN] 0,0,  '49040'		
 EXEC	[dbo].[PG_ENCABEZADO_LIBERAR_ORDEN] 0,0,  '47834'		
 EXEC	[dbo].[PG_ENCABEZADO_LIBERAR_ORDEN] 0,0,  '48110'		
...
AS	
	...
	SELECT	 [jobno]
			...
			,[PROGRAM_MODEL_RMA]
			-- ===========================
			,(CASE WHEN F_LIBERACION IS NULL THEN CONVERT(DATE, GETDATE())
					ELSE F_LIBERACION END ) AS F_LIBERACION
			-- ===========================
			,(CASE WHEN JEFE_GRUPO IS NULL THEN ''
					ELSE JEFE_GRUPO END ) AS JEFE_GRUPO
			-- ===========================
			,(CASE WHEN INSPECTOR_CALIDAD IS NULL THEN ''
