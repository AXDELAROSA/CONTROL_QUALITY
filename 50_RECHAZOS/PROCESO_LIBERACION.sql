	/*
		...
		WHERE KIT_RUTA.ITEM_NO = 'PLWLQCLWLNPT5'
		AND KIT_RUTA.MODELNO = 'WCL'
		AND KIT_RUTA.VERSIONNO = '0011'	

		--	SELECT * FROM DATA_02.[dbo].ccjobhdr_sql  WHERE JOBNO = '32900' 
		SELECT * FROM DATA_02.[dbo].ccjoblin_sql WHERE jobno = '29132' ORDER BY ser_no
		 
		SELECT * FROM [PPMS_PEARL].[dbo].certificacion_rpt where noserie_caja = '29132016' 

		SELECT * FROM [PPMS_PEARL].[dbo].Perforacion where noserie = '29132016' -- AND [status] = 'FINALIZADO'
		SELECT * FROM [PPMS_PEARL].[dbo].Trans_perfo where noserie = '29132016'
		SELECT TOP 100 * FROM DATA_02.DBO.[MATERIAL_PROGRAMADO_LOG] (NOLOCK) WHERE SERIAL = '29132016'
		
		SELECT TOP 100 * FROM DATA_02.DBO.[MATERIAL_PROGRAMADO_LOG] (NOLOCK) WHERE SERIAL = '29132016'
		SELECT * FROM DATA_02.DBO.[INVENTARIO_EMBARQUE] (NOLOCK) WHERE SERIAL_1 = '29132016'

		SELECT * FROM [PPMS_PEARL].DBO.[ORDEN_LIBERADA] (NOLOCK)  WHERE ORDEN IN ( '29132' )
		SELECT * FROM DATA_02.[dbo].ccjobhdr_sql (NOLOCK) WHERE JOBNO IN ( '29132' )
	...
	*/
	...
	--SELECT * FROM DATA_02.DBO.[MATERIAL_PROGRAMADO_LOG] (NOLOCK) WHERE SERIAL = '56744001'
	--SELECT * FROM DATA_02.DBO.[MATERIAL_PROGRAMADO] (NOLOCK) WHERE SERIAL LIKE '29132%'

	-- El serial: 29132016 no ha pasado por Inspección de Perforación!
	DECLARE @VP_RESULTADO	VARCHAR(300) = '', @PP_ORDEN VARCHAR(20) = '29132';
