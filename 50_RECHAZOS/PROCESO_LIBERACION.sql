	/*
		...
		SELECT * FROM DATA_02.DBO.[MATERIAL_PROGRAMADO_LOG] (NOLOCK) WHERE SERIAL = '53318001'
		SELECT * FROM DATA_02.DBO.[INVENTARIO_EMBARQUE] (NOLOCK) WHERE SERIAL_1 = '53318001'

		SELECT * FROM [PPMS_PEARL].DBO.[ORDEN_LIBERADA] (NOLOCK)  WHERE ORDEN IN ( '52933', '52989' )
		SELECT * FROM DATA_02.[dbo].ccjobhdr_sql WHERE JOBNO IN ( '52933', '52989' )
		SELECT * FROM [PPMS_PEARL].[dbo].[QC] WHERE Order_No IN ( '52933', '52989' ) 

		/*
			--UPDATE DATA_02.[dbo].ccjobhdr_sql 
			--	SET STATUS = 'C'
			--WHERE JOBNO IN ( '52933', '52989' ) 
		*/
	...
	*/
	...
	--	El serial: 53389002 no ha pasado por Inspección de Perforación!
	DECLARE @VP_RESULTADO	VARCHAR(300) = '', @PP_ORDEN VARCHAR(20) = '53818';
