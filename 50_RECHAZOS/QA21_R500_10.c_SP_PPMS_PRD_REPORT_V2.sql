...
/*
	EXEC	[dbo].[PG_REPORT_PPMS_PRD_X_DIA_PROCESO] 0, 144, '2022-01-01', '2022-01-30'
*/
...
/*
	EXEC	[dbo].[PG_REPORT_PRD_DEFECTO_X_MESA_FECHA_TURNO] 0, 144, '2022-02-23', '2022-02-23', 1
*/
...
AS
	...
	--DECLARE @TBL_RECHAZOS TABLE(
	--	MESA	VARCHAR(50),
	--	TURNO	INT
	--)
	
	---- /////////SE INGRESAN LOS DATOS A LA TABLA TEMPORAL//////////////
	--INSERT INTO @TBL_RECHAZOS
	--SELECT	(	SELECT LTRIM(RTRIM(Machine)) 
	...
	---- /////////SE MUESTRAN LOS DATOS DE LA TABLA TEMPORAL//////////////
	--SELECT MESA,
	--		TURNO,
	--		COUNT(TURNO) AS TOTAL_DEFECTO
	--FROM @TBL_RECHAZOS
	--GROUP BY MESA, TURNO
