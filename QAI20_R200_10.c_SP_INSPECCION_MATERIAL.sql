...
/*
 EXEC	[dbo].[PG_SK_INSPECCION_MATERIAL_X_NUMERO_PARTE_CON_OPCION] 0,0, 78, '200435AWT3',1,0,1
*/
	...
	IF @PP_TIPO_MOVIMIENTO = 1 -- SIGUIENTE
		...
		FROM	INSPECCION_MATERIAL
				...
				LEFT  JOIN [INSPECCION_MATERIAL_ORDEN] ON [INSPECCION_MATERIAL_ORDEN].K_INSPECCION_MATERIAL = INSPECCION_MATERIAL.K_INSPECCION_MATERIAL
						AND [INSPECCION_MATERIAL_ORDEN].NUMERO_PARTE = INSPECCION_MATERIAL.NUMERO_PARTE AND [INSPECCION_MATERIAL_ORDEN].K_ORDEN_COMPRA = @PP_K_ORDEN_COMPRA
				-- =============================
		WHERE	INSPECCION_MATERIAL.NUMERO_PARTE=@PP_NUMERO_PARTE
