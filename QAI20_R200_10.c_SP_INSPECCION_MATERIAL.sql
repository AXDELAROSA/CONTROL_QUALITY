...
/*
 EXEC	[dbo].[PG_SK_INSPECCION_MATERIAL_X_K_ITEM_CON_OPCION] 0,0, 78, '200435AWT3',1,0,1
*/
...
CREATE PROCEDURE [dbo].[PG_SK_INSPECCION_MATERIAL_X_K_ITEM_CON_OPCION]
	...
	@PP_K_ITEM						INT,
	@PP_K_INSPECCION_MATERIAL		INT,
	@PP_PRIMER_INSPECCION			INT, --#0 Cundo se abre ficha, #1 cuando se oprime adelande o atras 
	...
	IF @PP_TIPO_MOVIMIENTO = 1 -- SIGUIENTE
		...
		FROM	INSPECCION_MATERIAL
				...
				LEFT  JOIN [INSPECCION_MATERIAL_ORDEN] ON [INSPECCION_MATERIAL_ORDEN].K_INSPECCION_MATERIAL = INSPECCION_MATERIAL.K_INSPECCION_MATERIAL
						AND [INSPECCION_MATERIAL_ORDEN].K_ITEM = INSPECCION_MATERIAL.K_ITEM AND [INSPECCION_MATERIAL_ORDEN].K_ORDEN_COMPRA = @PP_K_ORDEN_COMPRA
				-- =============================
...
SELECT * FROM INSPECCION_MATERIAL
 EXEC	[dbo].[PG_SK_INSPECCION_MATERIAL_X_K_ITEM] 0,0, '200435AWT3'
*/
