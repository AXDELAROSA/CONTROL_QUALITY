...
/*
 EXEC	[dbo].[PG_LI_INSPECCION_MATERIAL] 0,0, '', -1,0
*/
...
/*
 EXEC	[dbo].[PG_SK_INSPECCION_MATERIAL_X_K_ITEM_CON_OPCION] 0,0, 10,	'10-001', 35, 3, 0, 2
*/
...
AS
	...
	DECLARE @VP_MENSAJE						VARCHAR(300) = ''
	DECLARE @VP_TOTAL_PORCENTAJE_ACUMULADO DECIMAL(13,2) = 0

	-- ////////////////////////////////////////////////
	SELECT @VP_TOTAL_PORCENTAJE_ACUMULADO = TOTAL_PORCENTAJE_ACUMULADO
	...
	IF @VP_TOTAL_PORCENTAJE_ACUMULADO IS NULL
		SET @VP_TOTAL_PORCENTAJE_ACUMULADO = 0
	...
	IF @PP_TIPO_MOVIMIENTO = 1 -- SIGUIENTE
		SELECT	TOP 1
				...
				D_TIPO_INSPECCION_MATERIAL, S_TIPO_INSPECCION_MATERIAL, 
				K_USUARIO_PEARL AS D_USUARIO_CAMBIO,
				ISNULL([INSPECCION_MATERIAL_ORDEN].OPCION_SELECCIONADA, '') AS OPCION_SELECCIONADA,
				ISNULL([INSPECCION_MATERIAL_ORDEN].COMENTARIO, '') AS COMENTARIO,
				@VP_TOTAL_PORCENTAJE_ACUMULADO AS TOTAL_PORCENTAJE_ACUMULADO
				-- =============================	
		FROM	INSPECCION_MATERIAL
				-- =============================
				INNER JOIN ESTATUS_INSPECCION_MATERIAL ON INSPECCION_MATERIAL.K_ESTATUS_INSPECCION_MATERIAL = ESTATUS_INSPECCION_MATERIAL.K_ESTATUS_INSPECCION_MATERIAL
				...
				INNER JOIN BD_GENERAL.dbo.USUARIO_PEARL ON INSPECCION_MATERIAL.K_USUARIO_CAMBIO = BD_GENERAL.dbo.USUARIO_PEARL.K_USUARIO_PEARL
				LEFT  JOIN [INSPECCION_MATERIAL_ORDEN] ON [INSPECCION_MATERIAL_ORDEN].K_INSPECCION_MATERIAL = INSPECCION_MATERIAL.K_INSPECCION_MATERIAL
						AND [INSPECCION_MATERIAL_ORDEN].K_ITEM = INSPECCION_MATERIAL.K_ITEM 
						AND [INSPECCION_MATERIAL_ORDEN].K_ORDEN_COMPRA = @PP_K_ORDEN_COMPRA
	...
	IF @PP_TIPO_MOVIMIENTO = 2 -- PARA ACTUALIZAR INSPECCION FO_AUTORIZAR_INSPECCION_MATERIAL
		...
		FROM	INSPECCION_MATERIAL
				...
				INNER JOIN INSPECCION_OPCION ON INSPECCION_MATERIAL.K_INSPECCION_MATERIAL = INSPECCION_OPCION.K_INSPECCION_MATERIAL
				INNER JOIN BD_GENERAL.dbo.USUARIO_PEARL ON INSPECCION_MATERIAL.K_USUARIO_CAMBIO = BD_GENERAL.dbo.USUARIO_PEARL.K_USUARIO_PEARL
				INNER JOIN [INSPECCION_MATERIAL_ORDEN] ON [INSPECCION_MATERIAL_ORDEN].K_INSPECCION_MATERIAL = INSPECCION_MATERIAL.K_INSPECCION_MATERIAL
					AND [INSPECCION_MATERIAL_ORDEN].K_ITEM = INSPECCION_MATERIAL.K_ITEM 
					AND [INSPECCION_MATERIAL_ORDEN].K_ORDEN_COMPRA = @PP_K_ORDEN_COMPRA
					AND	[INSPECCION_MATERIAL_ORDEN].ORDEN_COMPRA_PEDIDO = @PP_ORDEN_COMPRA_PEDIDO
				-- =============================
...
SELECT * FROM INSPECCION_MATERIAL
 EXEC	[dbo].[PG_SK_INSPECCION_MATERIAL_X_K_ITEM] 0,0, 35
*/
...
GO
/*
 EXECUTE [PG_IN_INSPECCION_MATERIAL] 0,0,  38 , 80.00 , 1 , 'El numero de parte fisico corresponde con el de la orden?' , 0.00 , 'Si' , 'No' , '' , '' , '' 
*/
