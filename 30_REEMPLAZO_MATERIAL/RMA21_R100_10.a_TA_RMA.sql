...
---- =================================================================================
EXECUTE [dbo].[PG_CI_STATUS_RMA] 0,0,80, 'NO IMPRESA',							'', 'NO-IMPR',	800,1
...
--	[L_APLICA_COBRO]				[INT] NOT NULL DEFAULT 0
--GO
--ALTER TABLE	[dbo].[HEADER_RMA]				-- AX: 20210712					
--ADD
--	[ATENCION_A]				[VARCHAR](250) NOT NULL DEFAULT ''
--GO

--ALTER TABLE	[dbo].[HEADER_RMA]				-- AX: 20211020					
--ADD
--	[K_STATUS_IMPRESION]			[INT] NOT NULL DEFAULT 80
--GO
--ALTER TABLE	[dbo].[HEADER_RMA]				-- AX: 20211020		
--ADD
--	[K_STATUS_ETIQUETA]			[INT] NOT NULL DEFAULT 80
--GO
...
--ALTER TABLE	[dbo].[DETAILS_RMA]				-- AX: 20211020					
--ADD
--	[K_STATUS_IMPRESION]			[INT] NOT NULL DEFAULT 80
--GO
