...
--	[PG_CB_CUSNO_RMA]
--	[PG_CB_CUSNO_RMA_OBSOLETOS]
--	[PG_CB_S_CUSNO_PROGRAM_RMA]
--	[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETOS]
--	[PG_CB_S_CUSNO_MODELNO_RMA]
--	[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO]
...
-- //////////////////////////////////////////////////////////////
-- // STORED PROCEDURE ---> CB / MUESTRA LOS CLIENTES CON VERSIONES ACTIVAS EN PEARL, PARA EL CAMBIO PARA MOSTRAR LOS CLIENTES AUNQUE TENGAN MODELOS OBSOLETOS.	AX: 20211122
-- //////////////////////////////////////////////////////////////
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CB_CUSNO_RMA_OBSOLETOS]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CB_CUSNO_RMA_OBSOLETOS]
GO
--		 EXECUTE [dbo].[PG_CB_CUSNO_RMA_OBSOLETOS] 0,0, 0
--		 EXECUTE [dbo].[PG_CB_CUSNO_RMA_OBSOLETOS] 0,0, 1
CREATE PROCEDURE [dbo].[PG_CB_CUSNO_RMA_OBSOLETOS]
	@PP_K_SISTEMA_EXE			INT,
	@PP_K_USUARIO				INT,
	--============================
	@PP_L_CON_TODOS				INT
AS
	...
	BEGIN
		...
		FROM	CCVERHDR_SQL		(NOLOCK),
				ARCUSFIL_SQL		(NOLOCK)
		WHERE	CCVERHDR_SQL.STATUS			IN ( 'L','A')
		AND		CCVERHDR_SQL.SPECSTATUS		IN ( 'U','A')
		AND		ARCUSFIL_SQL.CUS_NO			= CCVERHDR_SQL.cus_no
		ORDER BY CCVERHDR_SQL.CUS_NO
	END
...
-- //////////////////////////////////////////////////////////////
-- // STORED PROCEDURE ---> CB	/	MUESTRA LOS PROGRAMAS DE ACUERDO AL CLIENTE POR SIGLAS DEL CLIENTE, PARA EL CAMBIO PARA MOSTRAR LOS CLIENTES AUNQUE TENGAN MODELOS OBSOLETOS.	AX: 20211122
-- //////////////////////////////////////////////////////////////
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETOS]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETOS]
GO
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETOS] 0,139,'MAGN03',0
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETOS] 0,139,'MAGN03',1
CREATE PROCEDURE [dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETOS]
	@PP_K_SISTEMA_EXE			INT,
	@PP_K_USUARIO				INT,
	--============================
	@PP_CUSNO					VARCHAR(6),
...
-- // STORED PROCEDURE ---> CB / MUESTRA LOS MODELOS POR PROGRAMA ACTIVOS EN PEARL
-- //////////////////////////////////////////////////////////////
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO]
GO
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO] 1,139,'MAGN03','WK',0
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO] 1,139,'MAGN02','WL',0
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO] 1,139,'MAGN03','WK',1
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO] 1,139,'MAGN03','WL',1
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO] 1,139,'IRVI02','RU',1
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO] 1,139,'HOPE01','WD',0
CREATE PROCEDURE [dbo].[PG_CB_S_CUSNO_MODELNO_RMA_OBSOLETO]
	@PP_K_SISTEMA_EXE			INT,
	@PP_K_USUARIO				INT,
	--============================
	@PP_CUSNO					VARCHAR(6),
