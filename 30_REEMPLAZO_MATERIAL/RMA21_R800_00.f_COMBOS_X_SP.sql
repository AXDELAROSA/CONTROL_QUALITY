...
--	[PG_CB_CUSNO_RMA]
--	[PG_CB_CUSNO_RMA_OBSOLETO]
--	[PG_CB_S_CUSNO_PROGRAM_RMA]
--	[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETO]
...
-- //////////////////////////////////////////////////////////////
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CB_CUSNO_RMA_OBSOLETO]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CB_CUSNO_RMA_OBSOLETO]
GO
--		 EXECUTE [dbo].[PG_CB_CUSNO_RMA_OBSOLETO] 0,0, 0
--		 EXECUTE [dbo].[PG_CB_CUSNO_RMA_OBSOLETO] 0,0, 1
CREATE PROCEDURE [dbo].[PG_CB_CUSNO_RMA_OBSOLETO]
	@PP_K_SISTEMA_EXE			INT,
	@PP_K_USUARIO				INT,
	--============================
	@PP_L_CON_TODOS				INT
...
-- //////////////////////////////////////////////////////////////
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETO]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETO]
GO
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETO] 0,139,'MAGN03',0
--		 EXECUTE [dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETO] 0,139,'MAGN03',1
CREATE PROCEDURE [dbo].[PG_CB_S_CUSNO_PROGRAM_RMA_OBSOLETO]
	@PP_K_SISTEMA_EXE			INT,
	@PP_K_USUARIO				INT,
	--============================
	@PP_CUSNO					VARCHAR(6),
