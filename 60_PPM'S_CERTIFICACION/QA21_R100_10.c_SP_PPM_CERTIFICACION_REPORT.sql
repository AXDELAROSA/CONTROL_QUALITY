...
/*
	EXEC	[dbo].[PG_LI_PPMS_REPORT_X_MES] 0, 144, '2022-01-01'
*/
...
AS
	...
	-- /////////SE ONTIENE EL AÑO DE LA FECHA INICIAL///////////////////////////////////////
	DECLARE @VP_YEAR INT = YEAR(@PP_F_FIN)
	...
	SELECT	FORMAT(F_LIBERACION, 'MM') AS MES, 
			MUESTRA, 
			DEFECTOS 
	FROM [PPMS_PEARL].DBO.[ORDEN_LIBERADA] (NOLOCK)
	WHERE YEAR(F_LIBERACION) = @VP_YEAR 
...
/*	
	EXEC	[dbo].[PG_LI_PPMS_CERTIFICACION_TOTALES_REPORT_X_MES] 0, 144, '2022-01-31'
*/
