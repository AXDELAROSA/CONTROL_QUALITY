...
--No autorizado						--	#-1		NO AUTORIZADO
	...
	--WHERE	K_USUARIO_PEARL	IN	(42, 47, 48, 92, 86, 140, 94, 102, 138, 147, 170, 173,177)
	WHERE	K_USUARIO_PEARL	IN	(47, 48, 86, 92, 94, 102, 140, 173,	185, 167)
	--WHERE	K_USUARIO_PEARL	IN	(47, 48, 86, 92, 94, 101, 102, 138,	140, 147, 170, 173,	185)
	AND		L_BORRADO	= 0
...
--		 EXECUTE [dbo].[PG_CB_SER_LOT_NO] 1,139,'FNPJSA5'
