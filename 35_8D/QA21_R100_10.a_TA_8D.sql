...
CREATE TABLE [dbo].[8D] (
	...
	[DATE_CLOSED]		DATE			NULL,		-- FECHA DE CIEERE SE ASIGNA EN LA SECCION DE RECONOCIMINETO DEL EQUIPO
	[COMMENT]			VARCHAR(MAX)	NULL		-- RECONOCIMIENTO QUE SE LES HACE A LOS INTEGRANTES DEL EQUIPO DE LA 8D
)ON [PRIMARY]	
GO
